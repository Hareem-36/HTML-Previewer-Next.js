...
export default function HTMLPreview() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-b from-teal-600 to-cyan-100 text-foreground">
  ...
  <h1 className="text-2xl">Hareem Jaweid</h1>
</div>
